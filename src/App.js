  ...
  return (
    <div className="reddit_widget__post" key={id}>
      <div className="reddit_widget__posted_by">
        posted by{' '}
        <a href={authorUrl} className="reddit_widget__posted_by" target="_blank" rel="noopener noreferrer">
          u/{author}
        </a>
      </div>
      <a href={url} className="reddit_widget__title" target="_blank" rel="noopener noreferrer">
        {title}
      </a>
    </div>
  )
...
function App({ domElement }) {
  ...
  useEffect(() => {
    ...
    setLoading(true)
    fetch(`https://www.reddit.com/r/${widgetVariant}.json`)
  ...
  return (
    <div className="reddit_widget__app">
      <h1 className="reddit_widget__header">
        Latest posts in{' '}
        <a href={`https://reddit.com/r/${widgetVariant}`} rel="noopener noreferrer">
          /r/{widgetVariant}
        </a>
      </h1>
